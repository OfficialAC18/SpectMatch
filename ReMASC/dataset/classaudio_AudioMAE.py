...
def get_audiodset(args):
  ...
  FOLDER = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/Dataset-1/Dataset -1 Audio_MAE'
  TEST_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/Dataset-1/Dataset -1 Audio_MAE/Test'
  TRAIN_LABELED_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/Dataset-1/Dataset -1 Audio_MAE/Train/Labelled'
  TRAIN_UNLABELED_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/Dataset-1/Dataset -1 Audio_MAE/Train/Unlabelled'
  ...
  train_labeled_dataset = Audioset(labels = FOLDER, dir_files = TRAIN_LABELED_PATH,labeled=True,indexs = train_labeled_idxs,transform=None)
  ...
  test_dataset = Audioset(labels = FOLDER, dir_files = TEST_PATH,transform=None,train=False)
...
class TransformFixMatch(object):
    ...
    def __call__(self, weak, strong):
        ...
        weak = torch.einsum('cwh->chw',weak)
        strong = torch.einsum('cwh->chw',strong)
...
DSET_GETTERS_6 = {'classaudio_AudioMAE': get_audiodset}
