...
def get_audiodset(args):
  ...
  FOLDER = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/remasc/AST'
  TEST_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/remasc/AST/Oversampled/Test'
  TRAIN_LABELED_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/remasc/AST/Oversampled/Train/Labeled'
  TRAIN_UNLABELED_PATH = '/media/tower/d18329b1-fe35-43f8-8113-e096a40e5d3b/home/tower/Akchunya-Research/remasc/AST/Oversampled/Train/Unlabeled'
...
class TransformFixMatch(object):
    ...
    def __call__(self, weak, strong):
        weak = cv2.resize(weak,(298,128))
        strong = cv2.resize(strong, (298,128))
...
REMASC_GETTERS_2 = {'remasc_AST': get_audiodset}
